...
import { useBESSProducts, useCreateBESS, useUpdateBESS, useDeleteBESS, useSyncCatalog } from '@/hooks/useCatalog'
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="w-full max-w-md rounded-xl bg-white p-6 shadow-xl">
            ...
            <p className="mb-4 text-sm text-gray-500">
              ...
              Baterias e inversores vão para o catálogo BESS; painéis vão para o catálogo Solar.
            </p>
            <textarea
              rows={6}
              value={syncIds}
